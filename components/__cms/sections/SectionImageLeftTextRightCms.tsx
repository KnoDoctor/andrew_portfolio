...
interface SectionImageLeftTextRightCmsProps {
	section: any;
	handleSectionDataChange: any;
	handleExplicitSectionDataChange: any;
}

const SectionImageLeftTextRightCms = ({
	section,
	handleSectionDataChange,
	handleExplicitSectionDataChange,
}: SectionImageLeftTextRightCmsProps) => {
...
export default SectionImageLeftTextRightCms;
