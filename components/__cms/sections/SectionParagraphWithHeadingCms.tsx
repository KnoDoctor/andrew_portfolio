...
interface SectionParagraphWithHeadingCmsProps {
	section: any;
	handleSectionDataChange: any;
	handleExplicitSectionDataChange: any;
}

const SectionParagraphWithHeadingCms = ({
	section,
	handleSectionDataChange,
	handleExplicitSectionDataChange,
}: SectionParagraphWithHeadingCmsProps) => {
...
export default SectionParagraphWithHeadingCms;
