					...
					<Grid container spacing={5} sx={{ px: 5 }}>
						...
						<Grid item xs={12} md={7}>
							<Typography variant="body1" sx={{ textAlign: "justify", mb: 2 }}>
								...
								Laboriosam, culpa doloribus impedit labore magni, nemo ratione quo
								aliquid provident, dignissimos distinctio consequatur minus
								asperiores quam hic molestiae voluptatum iure laudantium.
							</Typography>
							<Typography variant="body1" sx={{ textAlign: "justify", mb: 2 }}>
								Lorem ipsum dolor sit amet consectetur, adipisicing elit.
								Laboriosam, culpa doloribus impedit labore magni, nemo ratione quo
